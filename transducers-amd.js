...
var TRANSDUCERS_DEV = !0, TRANSDUCERS_NODE_TARGET = !1, TRANSDUCERS_BROWSER_TARGET = !1, TRANSDUCERS_BROWSER_AMD_TARGET = !0;
...
com.cognitect.transducers.objectReduce = function(a, b, c) {
  for (var d in c) {
    if (b = a.step(b, [d, c[d]]), com.cognitect.transducers.isReduced(b)) {
      b = b.value;
      break;
    }
  }
...
TRANSDUCERS_BROWSER_AMD_TARGET && define("transducers", [], function() {
  return com.cognitect.transducers;
});
})();
